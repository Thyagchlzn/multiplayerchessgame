...
def drawBoard(win):
    win.fill(pygame.Color("black"))#color should be changed
    pygame.draw.rect(win,(232,247,249), (50, 50, 400, 400))
    for y in range(1, 9):
        for x in range(1, 9):
            if (x + y) % 2 == 0:
                pygame.draw.rect(win,(160,227,233), (50 * x, 50 * y, 50, 50))
...
def prompt(win, msg=None):
    pygame.draw.rect(win, (255, 255, 255), (110, 160, 280, 130))
    pygame.draw.rect(win, (0, 0, 0), (110, 160, 280, 130), 4)

    pygame.draw.rect(win, (255, 255, 255), (120, 160, 260, 60), 2)
    pygame.draw.rect(win, loader.GREY, (140, 240, 60, 28))
    pygame.draw.rect(win, loader.GREY, (300, 240, 50, 28))
