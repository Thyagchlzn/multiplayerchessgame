...
from tools.loader import ONLINE,GREY, BACK, putLargeNum, putNum

# Shows a small popup when user requests game with wrong player.
def showUpdateList(win):
    pygame.draw.rect(win, (255, 255, 255), (110, 220, 280, 60))
    pygame.draw.rect(win,(255, 255, 255), (110, 220, 280, 60))
...
def showLoading(win, errcode=0):
    pygame.draw.rect(win, (255, 255, 255), (100, 220, 300, 80))
    pygame.draw.rect(win, (0,0,0), (100, 220, 300, 80),3)
    ...
    pygame.draw.rect(win, GREY, (220, 270, 65, 20))
...
def popup(win, sock, typ):
    pygame.draw.rect(win, (255, 255, 255), (130, 220, 240, 80))
    pygame.draw.rect(win, (0, 0, 0), (130, 220, 240, 80), 4)
...
def request(win, sock, key=None):
    if key is None:
        pygame.draw.rect(win, (255, 255, 255), (100, 210, 300, 100))
        pygame.draw.rect(win,(0, 0, 0), (100, 210, 300, 100), 4)
        ...
        pygame.draw.rect(win,(255, 255, 255), (100, 160, 300, 130))
        pygame.draw.rect(win, (0, 0, 0), (100, 160, 300, 130), 4)
        ...
        pygame.draw.rect(win, GREY, (140, 240, 50, 28))
        pygame.draw.rect(win, GREY, (300, 240, 50, 28))
...
def draw(win, sock, requester=True):
    if requester:
        ...
        pygame.draw.rect(win, (0, 0, 0), (100, 220, 300, 60), 4)
...
def showLobby(win, key, playerlist):
    ...
    pygame.draw.rect(win, (0,0, 0), (65, 10, 355, 68), 4)
    win.blit(BACK, (460, 0))
    win.blit(ONLINE.LIST, (20, 75))
    win.blit(ONLINE.REFRESH, (270, 85))
    pygame.draw.line(win, (0, 0, 0), (20, 114), (190, 114), 3)
    pygame.draw.line(win, (0,0, 0), (210, 114), (265, 114), 3)
    ...
    for cnt, player in enumerate(playerlist):
        ...
        pygame.draw.rect(win, GREY, (300, yCord + 2, 175, 26))
        win.blit(ONLINE.REQ, (300, yCord))

    win.blit(ONLINE.YOUARE, (100, 430))
    pygame.draw.rect(win, (0,0, 0), (250, 435, 158, 40), 3)
