...
def prompt(win):
    ...
    pygame.draw.rect(win, loader.GREY, (160, 270, 25, 20), 3)
    win.blit(SINGLE.NOTNOW, (250, 270))
    pygame.draw.rect(win, loader.GREY, (250, 270, 70, 20), 3)
...
def showScreen(win, sel, sel2, lvl):
    win.fill((255, 220, 255))
    win.blit(loader.BG1,(0,0))
    #rounded_rect(win, (255, 255, 255), (70, 5, 340, 60), 0, 0)
    ...
    pygame.draw.rect(win, loader.GREY, (170, 210, 140, 30))
